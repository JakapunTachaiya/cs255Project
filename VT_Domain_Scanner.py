...
_inputPath = 'wilderURL1.txt'
_outputPath = 'wilderURL1_label.txt'
...
while True:
    ...
    DomainScanner(domain1, _api1)
    count=count+1
    print('count: ',count,'Passing ',domain2)
    count = count + 1
    DomainScanner(domain2, _api2)

    time.sleep(15)
    DomainReportReader(domain1, _api1)
    time.sleep(15)
    DomainReportReader(domain2, _api2)
    results.close()
