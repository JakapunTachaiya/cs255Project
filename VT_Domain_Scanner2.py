...
_inputPath = 'wilderURL2.txt'
_outputPath = 'wilderURL2_label.txt'
...
while True:
    ...
    DomainScanner(domain1, _api3)
    count = count + 1
    print('count: ', count, 'Passing ', domain2)
    count = count + 1
    DomainScanner(domain2, _api4)

    time.sleep(15)
    DomainReportReader(domain1, _api3)
    time.sleep(15)
    DomainReportReader(domain2, _api4)
    results.close()
