...
_inputPath = 'wilderURL3.txt'
_outputPath = 'wilderURL3_label.txt'
...
while True:
    ...
    DomainScanner(domain1, _api5)
    count = count + 1
    print('count: ', count, 'Passing ', domain2)
    count = count + 1
    DomainScanner(domain2, _api6)

    time.sleep(15)
    DomainReportReader(domain1, _api5)
    time.sleep(15)
    DomainReportReader(domain2, _api6)
    results.close()
