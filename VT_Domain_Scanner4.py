...
_inputPath = 'wilderURL4.txt'
_outputPath = 'wilderURL4_label.txt'
...
while True:
    ...
    DomainScanner(domain1, _api7)
    count = count + 1
    print('count: ', count, 'Passing ', domain2)
    count = count + 1
    DomainScanner(domain2, _api8)

    time.sleep(15)
    DomainReportReader(domain1, _api7)
    time.sleep(15)
    DomainReportReader(domain2, _api8)
    results.close()
